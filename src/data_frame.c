...
void data_frame_copy_component(
    data_frame* frame,
    blocks* bls,
    size_t block_height,
    size_t block_width,
...
uint8_t* data_frame_fill_y_component(data_frame_filler_params params) {
...
uint8_t* data_frame_fill_u_component(data_frame_filler_params params) {
...
uint8_t* data_frame_fill_v_component(data_frame_filler_params params) {
...
void data_frame_to_blocks(data_frame* frame, blocks* bls) {
    ...
    data_frame_copy_component(
        frame,
        bls,
        BLOCKS_Y_HEIGHT,
        BLOCKS_Y_WIDTH,
        DATA_FRAME_Y_HEIGHT,
        data_frame_fill_y_component
    );
